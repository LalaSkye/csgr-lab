...
**Repository:** csgr-lab
**Purpose:** Contracted stability and drift measurement for LLM behaviour — deterministic scoring, hash-chained evidence, reproducible runs.
**Author:** Ricky Dean Jones
**Repository owner:** [LalaSkye](https://github.com/LalaSkye)
**Organisation:** Os-Trilogy LMT / AlvianTech
**Architecture layer:** Measurement / Audit
**Licence:** MIT

## Related Artefacts

TrinityOS, AlvianTech, Execution Boundary Series, constraint-workshop, invariant-lock

## Public vs Private

**Public (this repository):** Scoring engine, evidence logger, drift detector, CLI, contract format specification.

**Private (withheld by design):** Production contract definitions. Internal scoring baselines.

## Identity Binding

- **GitHub:** [LalaSkye](https://github.com/LalaSkye)
- **LinkedIn:** [Ricky Jones](https://linkedin.com/in/ricky-jones-1b745474)
- **Email:** ricky.mcjones@gmail.com
- **Zenodo:** [Ricky Dean Jones publications](https://zenodo.org/search?q=ricky%20dean%20jones)
